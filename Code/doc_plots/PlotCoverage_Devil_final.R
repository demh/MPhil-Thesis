...
#          different contigs in a tab-separated manner, round off according to the window size.
#          It has to include a header and it is generated by GenerateBedFile_Devil.R. e.g.
#
#          chr  length
